...
public class GlutenFreeShop implements Manufacturer {
    ...
    private Map<Product, Integer> createProductList() {
        ...
        productsList.put(new GlutenFreeProduct("shitake mushrooms", "dried"), 140);
        productsList.put(new GlutenFreeProduct("coconut milk", "one can of coconut milk"), 30);
        productsList.put(new GlutenFreeProduct("kimchi", "ingredients: chinese cabbage, turnip greens"), 110);
